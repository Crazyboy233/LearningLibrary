...
// 编译命令
// g++ test/05_test.cpp ./core/*.cc -I./core/

/* 该测试是基于 04_test.cpp 增加了如下内容：
    对于 Tensor ，增加了 shape。 增加了 MatMulOp
    该测试仅测试 shape 功能
*/ 
...
int main() {
    ...
    */
    ...
    Tensor x({3}, {2.0, 3.0, 4.0}); // shape={3}, 一维向量
    Tensor target({3}, {10.0, 12.0, 12.0});
    Parameter w({3}, {0.0, 1.0, 2.0});
